// Shim for admin_localisation.js removed during migration to Google Maps
console.warn('admin_localisation.js has been replaced by admin_localisation.google.js. This shim avoids errors.');
if (window.GoogleMapsIntegration && typeof window.GoogleMapsIntegration === 'function') {
  // no-op: admin logic moved to admin_localisation_google.js
}
    ...
    if (typeof map !== 'undefined') {
        ...
        style.textContent = `
            ...
            .zone-marker-content {
                ...
                padding: 8px 12px;
                border-radius: 20px;
                box-shadow: 0 4px 12px rgba(10, 56, 79, 0.3);
            ...
            .zone-marker-content:hover {
                transform: translateY(-2px);
                box-shadow: 0 6px 20px rgba(10, 56, 79, 0.4);
            ...
            /* Styles pour les popups de zones */
            .zone-popup {
                min-width: 250px;
            }
            ...
            .zone-default {
                background: linear-gradient(135deg, #79aec8, rgba(121, 174, 200, 0.15));
                border-color: #0a384f;
            }
            
            .zone-hover {
                background: linear-gradient(135deg, #f7c948, rgba(247, 201, 72, 0.3));
                border-color: #f7c948;
            }
            
            .zone-selected {
                background: linear-gradient(135deg, #d17e54, rgba(209, 126, 84, 0.25));
                border-color: #d17e54;
            }
